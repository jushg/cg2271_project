...
void toggleGreenLED(int greenLEDCounter) {	
	offGreenLEDs();
	int greenLedArray[8] = {MASK(GREEN_LED_01), MASK(GREEN_LED_02), MASK(GREEN_LED_03), MASK(GREEN_LED_04), MASK(GREEN_LED_05), MASK(GREEN_LED_06), MASK(GREEN_LED_07), MASK(GREEN_LED_08)};
